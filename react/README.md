...
## Demo Video
This is full React + Node.js Express JWT Authentication & Authorization demo (with form validation, check signup Email/email duplicates, test authorization with 3 roles: Admin, Moderator, User):
